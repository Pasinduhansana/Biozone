...
const FAQ = () => {
	...
	return (
		<div className="min-h-screen flex items-center justify-center">
			<div className="max-w-4xl mx-auto self-center">
				...
				<p className="text-gray-600 text-center mb-10 pt-4">
					From foundational concepts to advanced topics, we're here to help you
					learn and grow your knowledge about the wonders of life.
				</p>
							...
							<div
								className={`pb-4 text-gray-600 transition-all duration-500 ease-in-out ${
									openIndex === index
										...
										: "max-h-0 opacity-0 overflow-hidden sm:text-left text-center"
								}`}
							>
								{faq.answer}
							</div>
